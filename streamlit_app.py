...
c5, c6, c7 = st.columns(3) # On passe à 3 colonnes pour inclure l'Export
...
with c7:
    # Bouton Export (C'est ici qu'était l'erreur)
    # On utilise st.info (bleu) ou st.success (vert) à la place de st.primary
    st.info("### 📩 Export PDF")
