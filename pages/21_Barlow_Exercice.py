...
# Masquer la sidebar pour rester concentré
st.markdown("""
    <style>
...
# ==============================================================================
# LOGIQUE DES FORMULAIRES (Votre code d'origine déplacé ici)
# ==============================================================================
...
# TYPE 10 : PLAN MAINTIEN
    ...
    if st.button("Retour"): st.switch_page("pages/00_Mon_Parcours.py")